...
//console.log("faz assim, mas vc escreve isso num comentario!!!!!!feio")
...
function setup() {
  ...
  gameOver = createSprite(width/2,windowHeight/2-250);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(width/2,windowHeight/2+-200);
